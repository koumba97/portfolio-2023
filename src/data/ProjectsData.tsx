...
export const ProjectsData: ProjectInterface[] = [
    {
        ...
        stack: [StackList.procreate, StackList.clip_studio_paint, StackList.photoshop],
        coverImage:
...

    {
        ...
        stack: [StackList.photoshop, StackList.in_design],
        coverImage:
    ...
    },
    {
        ...
        stack: [StackList.react_js, StackList.node_js, StackList.symfony],
        coverImage:
...

    {
        ...
        category: ['WEB_DEVELOPMENT', 'GRAPHIC_DESIGN'],
        stack: [StackList.laravel, StackList.jquery, StackList.php_my_admin, StackList.sass],
        coverImage:
    ...
    },
    {
        ...
        stack: [StackList.react_native, StackList.node_js, StackList.firebase, StackList.sass],
        coverImage:
...

    {
        ...
        category: ['GRAPHIC_DESIGN'],
        stack: [StackList.in_design, StackList.illustrator, StackList.photoshop],
        coverImage:
...

    {
        ...
        category: ['WEB_DEVELOPMENT'],
        stack: [StackList.php, StackList.javascript, StackList.html, StackList.css],
        coverImage:
