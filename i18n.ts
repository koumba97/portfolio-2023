...
const resources = {
    ...
    fr: {
        translation: {
            ...
            ABOUT_ME_CONTENT:
                "<p>Je m'appelle Koumba, j'habite à Paris et je suis développeuse web depuis 3 ans.</p>\n\n<p>Passionnée par le design et le dessin, j'ai d'abord étudié le design graphique avant de me réorienter vers le développement web.</p>\n\n<p>Ici, sont présentés quelques uns de mes travaux personnels, scolaires et professionnels.</p>\n\n<p>Bonne visite !</p>",
